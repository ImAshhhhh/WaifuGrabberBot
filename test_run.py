...
async def main():
    ...
    print()
    print("   ⚠️  IMPORTANT: Make sure your bot has Group Privacy Mode OFF")
    print("      so it can see ALL group messages (not just commands).")
    print("      Go to @BotFather → /mybots → your bot → Bot Settings →")
    print("      Group Privacy → Turn off.")
    print()
    print("   Then add the bot to a group as ADMIN,")
    print("   send 10 messages, and watch a character spawn!")
    print()
